...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": (
        # CRITICAL: JWT MUST be first for SPA! SessionAuth was causing user identity leakage
        # where admin session cookies were reused for all users regardless of JWT token
