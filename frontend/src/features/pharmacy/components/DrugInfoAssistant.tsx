        ...
        <div className="rounded-lg border border-indigo-100 bg-indigo-50/50 p-4">
            <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                    ...
                    <h3 className="text-sm font-semibold text-indigo-900">AI Drug Assistant</h3>
                </div>
                {!isOpen && (
                    <button
                        type="button"
                        ...
                        className="inline-flex items-center rounded-md bg-indigo-600 px-3 py-1.5 text-xs font-semibold text-white shadow-sm hover:bg-indigo-500 disabled:opacity-50"
                    >
                        {isLoading ? (
                            <>
            ...
            {isOpen && info && (
                <div className="mt-4 animate-in fade-in slide-in-from-top-2">
                    <div className="prose prose-sm max-w-none rounded-md bg-white p-4 shadow-sm ring-1 ring-gray-200">
                        ...
                        <div className="mt-3 flex items-start space-x-2 rounded-md bg-yellow-50 p-2 text-xs text-yellow-800">
