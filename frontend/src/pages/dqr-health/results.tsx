        ...
        <MainLayout>
            <div className="min-h-screen bg-gray-50 py-12">
                <div className="container mx-auto px-4 max-w-5xl">
                    ...
                    {advice && (
                        <div className="bg-white rounded-2xl shadow-xl overflow-hidden mb-16 animate-fade-in border border-blue-100">
                            <div className="bg-gradient-to-r from-[#00A3AD] to-[#00C4CC] p-6 text-white flex items-center justify-between">
