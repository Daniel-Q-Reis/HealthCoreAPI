    ...
    return (
        <section className="pt-32 pb-20 px-6">
            <div className="max-w-4xl mx-auto text-center">
                {/* Badge */}
                <div className="inline-block mb-4 px-4 py-1.5 rounded-full bg-slate-800 border border-slate-700 text-brand-accent text-sm font-semibold tracking-wide">
                    {t(`hero.badge_${lang}`)}
                </div>
                ...
                <div className="mb-10 h-48 relative overflow-hidden rounded-xl border border-slate-700">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <a
                        ...
                        className="group bg-brand-accent hover:bg-blue-600 text-white font-semibold py-3.5 px-8 rounded-lg transition-all flex items-center justify-center gap-2"
                    >
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="group bg-slate-800 hover:bg-slate-700 text-white font-semibold py-3.5 px-8 rounded-lg border border-slate-700 transition-all flex items-center justify-center gap-2"
                    >
                ...
                <p className="mt-4 text-xs text-slate-500 tech-font">
